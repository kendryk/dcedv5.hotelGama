 ...
 */
final class Version20201109153811 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking ADD user_id INT NOT NULL, ADD accomodation_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking DROP user_id, DROP accomodation_id');
    }
}
